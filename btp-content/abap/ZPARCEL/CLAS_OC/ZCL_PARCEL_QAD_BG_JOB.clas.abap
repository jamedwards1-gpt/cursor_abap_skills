CLASS zcl_parcel_qad_bg_job DEFINITION PUBLIC FINAL CREATE PUBLIC.
...
CLASS zcl_parcel_qad_bg_job IMPLEMENTATION.
  ...
  METHOD if_apj_rt_run~execute.
    TRY.
        ...
        lo_log->add_item( cl_bali_free_text_setter=>create(
          ...
          text     = |Parcel QAD job started at { cl_abap_context_info=>get_system_time( ) }|
        ) ).
  ...
  METHOD if_apj_rt_run~get_text.
    rv_text = 'Parcel QAD poll and discover (background)'.
  ENDMETHOD.
ENDCLASS.
